 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://service.jaxws.module.maven.he.com/", wsdlLocation = "http://localhost:9089/service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://service.jaxws.module.maven.he.com/", "ServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9089/service?wsdl");
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(new QName("http://service.jaxws.module.maven.he.com/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jaxws.module.maven.he.com/", "ServiceImplPort"), ServiceImpl.class, features);
    }
