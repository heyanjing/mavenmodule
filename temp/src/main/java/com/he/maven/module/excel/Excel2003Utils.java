...
/**
 * Created by heyanjing on 2017/12/1 15:30.
 */
...
public class Excel2003Utils {
    private static final Logger log = LoggerFactory.getLogger(Excel2003Utils.class);
     ...
     * @param objects     目标数据集
     */
    public static File writeExcel(String directory, String fileName, String sheetName, List<String> columnNames, String sheetTitle, List<List<Object>> objects, boolean append) throws IOException {
